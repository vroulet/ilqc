# Code adapted from Patrick Ridge
# Original can be found at https://github.com/patrick-kidger/torchcubicspline
# Apache License 2.0
...
def natural_cubic_spline_coeffs(t, x):
    ...
    Returns:
        ...
        (c) Save the result.
        (d) Treat the result as your dataset as far as PyTorch's `torch.utils_pipeline.data.Dataset` and
            `torch.utils_pipeline.data.DataLoader` classes are concerned.
        (e) Call NaturalCubicSpline as the first part of your model.

        See also the accompanying fhc_example.py.
    """
    _validate_input(t, x)
