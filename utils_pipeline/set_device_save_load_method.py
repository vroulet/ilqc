...
def get_device() -> Device:
    ...
    Returns:
      device: device from where to save/load/treat data
    """
...
def set_save_load_procedure(type_files: str = 'torch') -> tuple[Callable, Callable, str]:
    """Set the base functions to save, load files  and define the associated extensions.
    
    Args:
      type_files: type of files (pickle or torch)
